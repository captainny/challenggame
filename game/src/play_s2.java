...
public class play_s2 extends JPanel implements ActionListener,Runnable{
	ImageIcon bg = new ImageIcon(this.getClass().getResource("bg.png"));
        ImageIcon s_2 = new ImageIcon(this.getClass().getResource("s_2.png"));
	public ArrayList<scopee> scopee = new ArrayList<>();
                ...
                this.addKeyListener(new KeyAdapter(){
                    ...
                    public void keyPressed(KeyEvent e){
                        ...
                        for(int i=0 ; i<ap.size();i++){
                            for(int j=0 ; j<scopee.size();j++){
                                if(Intersect(ap.get(i).getbound(),scopee.get(j).getbound())){
                                    ap.remove(i);
	...
	public void paintComponent(Graphics g){
            ...
            for(int i=0 ; i<scopee.size();i++){
                g.drawImage(scopee.get(i).getImage(),scopee.get(i).getX(),scopee.get(i).getY(),100,100,this);
            }       
            ...
            g.drawImage(s_2.getImage(),675,100,300,300, this);
